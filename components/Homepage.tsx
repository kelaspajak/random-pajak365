...
export default function Page() {
  return (
    <div>
      ...
      <NextSeo
        title='Pajak365'
        description='Launch SEO friendly, blazing fast websites from Notion, Google Sheets, GitHub, Airtable with Pajak365"'
        canonical='https://www.pajak365.com/'
        openGraph={{
          title: 'Pajak365',
          url: 'https://www.pajak365.com/',
          images: [
            {
              url: 'https://www.pajak365.com/pajak365.jpg',
              alt: 'Launch SEO friendly, blazing fast websites from Notion, Google Sheets, GitHub, Airtable with Pajak365',
            },
          ],
          description:
          ...
          <div className='px-4 mx-auto max-w-7xl sm:px-6 lg:px-8'>
            <div className='lg:text-center'>
              ...
              <p className='max-w-2xl mt-4 text-xl text-gray-500 lg:mx-auto'>
                Customize most of your Pajak365 site <br />
...
const features = [
  {
    ...
    description:
      'Creating and deploying a Pajak365 site from Notion, Airtable, Google Sheets or GitHub takes less than a minute of your valuable time',
    icon: HiOutlineGlobeAlt,
  },
  {
    name: 'Static Pages',
    description:
      'All the Pajak365 sites are statically rendered in the server so that your site always remains lightning fast. Your Pajak365 site can have some dynamics pieces too',
  ...
  },
  {
    name: 'Custom styles',
    description:
      "Don't like the default styles? You can style your Pajak365 site and customize it to your hearts content and make it look different",
    icon: FaRegEdit,
  },
  {
  ...
  },
  {
    name: 'And much more',
    description:
      "This is only the tip of the iceberg. There's still a loooot more that you can do with Pajak365. Discover them in the guides section",
    icon: VscRocket,
  },
];
